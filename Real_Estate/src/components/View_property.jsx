...
import house2 from './images/house-img-1.webp';
        ...
        <>
            ...
            <section className="view-property">
                ...
                <div className="details">
                    ...
                    <p class="location"><i class="fas fa-map-marker-alt"></i><span>Maninagar, Ahmedbad-380050</span></p>
                    <div class="info">
                        <p><i class="fas fa-tag"></i><span>15 lac</span></p>
                        <p><i class="fas fa-user"></i><span>Shubham (owner)</span></p>
